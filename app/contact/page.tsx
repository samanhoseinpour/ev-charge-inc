    ...
    <main className="min-h-[100svh] isolate px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-1155/678 w-144.5 max-w-none -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#2C5530] to-[#2C5530] opacity-20 sm:left-[calc(50%-40rem)] sm:w-288.75"
        />
      </div>
